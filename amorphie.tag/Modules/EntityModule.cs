...
public static class EntityModule
{
    ...
    static IResult getEntity(
        [FromRoute(Name = "domainId")] Guid domainId,
        [FromRoute(Name = "entityId")] string entityId,
        [FromServices] TagDBContext context

    )
    {
        // Entity tablosuna entityId ve domainId parametrelerine göre sorgu atılır.
        ...
        var entity = context!.Entities!
            ...
            .ThenInclude(s => s.Tag)
            .Where(e => e.Name == entityId && e.DomainId == domainId)
            .FirstOrDefault();
    ...
    {
        //Entity tablosundan entityId ve domainId göre kayıt siler.
        //Entity tablosunda entityId ve domainId eşleşen kayıt varsa Entity Data tablosundaki ilişkili kayıtlarınıda siler.
        //Entity tablosunda entityId ve domainId eşleşen kayıt yoksa 204 döndürür.


        //Entity tablosuna sorgu atar entityId ve domainId ile eşleşen kayı varsa siler
        if (await context.Entities!.Where(e => e.Id == entityId && e.DomainId == domainId).ExecuteDeleteAsync() == 1)
        {
            ...
            await context.EntityData!.Where(d => d.EntityId == entityId).ExecuteDeleteAsync();
            return Results.Ok();
        }
        //Entity tablosunda entityId ve domainId ile eşleşen kayıt yoksa 204 döndürür.
        else
        {
            return Results.NoContent();
        }
